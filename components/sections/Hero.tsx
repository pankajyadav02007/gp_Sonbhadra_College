...
export default function Hero() {
  ...
  const slides = [
    ...
    },
    {
      ...
      image:
        'https://www.bennett.edu.in/wp-content/uploads/2024/12/Navigating-Campus-Resources-at-Bennett-University-A-Step-by-Step-Guide.jpg',
    },
    {
      ...
      image:
        'https://www.makehappen.org/wp-content/uploads/2020/04/600-campus-75731374.jpg',
    },
  ];
    ...
    <div className={poppins.className}>
      ...
      >
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 text-center mt-20">
          <h1
            className={`text-4xl md:text-6xl font-bold text-white mb-4 ${playfair.className}`}
          >
      ...
      {showScrollTop && (
        <button
          ...
          className="fixed right-6 bottom-6 z-50 bg-blue-500 text-white p-3 rounded-full shadow-lg hover:scale-110 transition"
...
function StatCard({
  ...
  return (
    <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 text-center border border-white/20 hover:scale-105 transition">
