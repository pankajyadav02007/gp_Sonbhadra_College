  ...
  const facilities = [
    {
      ...
      description: 'Spacious and well-ventilated classrooms equipped with modern teaching aids and comfortable seating',
      color: 'blue',
    },
    {
      icon: Microscope,
      title: 'Advanced Laboratories',
      description: 'State-of-the-art labs with latest equipment for practical training in all engineering disciplines',
      color: 'green',
    },
    {
      icon: Laptop,
      title: 'Computer Centers',
      description: 'High-performance computers with latest software and high-speed internet connectivity',
      color: 'purple',
    },
    {
      icon: Library,
      title: 'Digital Library',
      description: 'Extensive collection of books, journals, and e-resources with comfortable reading spaces',
      color: 'orange',
    },
    {
      icon: Wifi,
      title: 'Wi-Fi Campus',
      description: 'Complete campus-wide Wi-Fi coverage for seamless internet access',
      color: 'red',
    },
    {
      icon: Droplets,
      title: 'Sports Facilities',
      description: 'Well-maintained sports grounds and indoor facilities for physical fitness and recreation',
      color: 'teal',
    },
  ];
